...
;(function (root, factory) {
  if (typeof define === 'function' && (define.amd||define.cmd)) {
      ...
      root.customBrowser = factory(root);
  }
  ...
  return function (userAgent) {
      ...
      _this.customBrowserInfomation = {engine:_this.engine,browserVersion:_this.version,osVersion:_this.osVersion,browser:_this.browser,device:_this.device,os:_this.os,language:_this.language,Device:_this.Device}
  };
}));
